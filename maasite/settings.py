"""
Django settings for maasite project.
...
SECRET_KEY = 'django-insecure-j^+=snzga3$636rfl__k5uasljo*6strb=z8!ayg+=(l50@r^%'
...
WSGI_APPLICATION = 'maasite.wsgi.application'
